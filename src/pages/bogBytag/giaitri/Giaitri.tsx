...
import { getListBlog, getListTagAmthuc, getListTagGiaitri } from '~/stores/features/blog/blog.slice.ts'
...
const Giaitri: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const blogsResponse = await getListTagGiaitri()
