...
import {
  ...
  getListTagAmthuc,
  getListTagCongnghe,
  getListTagGiaitri, getListTagThethao
} from '~/stores/features/blog/blog.slice.ts'
...
const ThethaoDetail: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const blogsResponse = await getListTagThethao()
