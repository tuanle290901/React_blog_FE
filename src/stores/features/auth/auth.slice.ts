...
export const Login2 = async (payload: { email: string, password: string }) => {
  try {
    return await HttpService.post('/auth/login', payload)
  } catch (e) {
    console.log(e)
  }
}
...
export const register = async (payload: {
  ...
  try {
    return await HttpService.post('/auth/register', payload)
  } catch (e) {
    console.log(e)
  }
}
